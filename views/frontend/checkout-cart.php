...
$title='Thanh toán';
?>
<?php if(isset($_REQUEST['cartnow'])):?>
   <?php require_once 'views/frontend/checkout-cartnow.php' ;?>
<?php else:?>
         ...
         <div class="row">
            ...
            <div class="col-md-6">
               ...
               <table class="table table-borderless">
                  ...
                  <tbody>
                     <?php if(count($list_cart)>0):?>
                        ...
                        <tr>
                           <td class="text-center align-middle"><?=$stt;?></td> <?php $stt++;?>
                           <td>
                              <img class="img-fluid" src="public/images/product/<?=$cart['image'];?>" alt="<?=$cart['image'];?>">                           </td>
                     ...
                     <?php else:?>
                        <tr>
                           <td colspan="7">Chưa có sản phẩm trong giỏ hàng</td>
                        </tr>
                     <?php endif;?> 
                  </tbody>
                  <tfoot>
                     <tr>
                        <td colspan="6" class="text-end">
                           <strong>Tổng tiền: <?=number_format(Cart::cartTotal());?><sup>Đ</sup></strong>
                        </td>
                     </tr>
                  </tfoot>
               </table>
               ...
               <table class="table table-borderless">
                  <tr>
                     <th>Tạm tính</th>
                     <td class="text-end"><?=number_format(Cart::cartTotal());?> đ</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     <th>Tổng cộng</th>
                     <td class="text-end"><strong><?=number_format(Cart::cartTotal());?> đ</strong></td>
                  </tr>
               </table>
            </div>
         </div>
