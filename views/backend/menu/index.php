                           ...
                           <div class="card mb-0">
                              ...
                              <div id="collapseCategory" class="collapse" aria-labelledby="headingCategory"
                                 ...
                                 <div class="card-body p-3">
                                    ...
                                    <?php endforeach;?>
                                    <div class="my-3">
                                       <button name="THEMCATEGORY" type="submit" value="Thêm Menu"
                                       class="btn btn-sm btn-success form-control">Thêm Menu</button>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           <div class="card mb-0">
                              ...
                              <div id="collapseBrand" class="collapse" aria-labelledby="headingBrand"
                                 ...
                                 <div class="card-body p-3">
                                    ...
                                    <?php endforeach;?>
                                    <div class="my-3">
                                       <button name="THEMBRAND" type="submit" value="Thêm Menu"
                                       class="btn btn-sm btn-success form-control">Thêm Menu</button>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="card mb-0">
                              ...
                              <div id="collapseTopic" class="collapse" aria-labelledby="headingTopic"
                                 ...
                                 <div class="card-body p-3">
                                    ...
                                    <?php endforeach;?>
                                    <div class="my-3">
                                       <button name="THEMTOPIC" type="submit" value="Thêm Menu"
                                       class="btn btn-sm btn-success form-control">Thêm Menu</button>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="card mb-0">
                              ...
                              <div id="collapsePage" class="collapse" aria-labelledby="headingPage"
                                 ...
                                 <div class="card-body p-3">
                                    ...
                                    <?php endforeach;?>
                                    <div class="my-3">
                                       <button name="THEMPAGE" type="submit" value="Thêm Menu"
                                       class="btn btn-sm btn-success form-control">Thêm Menu</button>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="card mb-0">
                              ...
                              <div id="collapseCustom" class="collapse" aria-labelledby="headingCustom"
                                 ...
                                 <div class="card-body p-3">
                                    ...
                                    <div class="my-3">
                                       <button name="THEMCUSTOM" type="submit" value="Thêm Menu"
                                       class="btn btn-sm btn-success form-control">Thêm Menu</button>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <tr class="datarow">
                                 ...
                                 <td>
                                    ...
                                    <div class="function_style">
                                       ...
                                       <a class ="btn btn-primary btn-xs" href="index.php?option=menu&cat=show&id=<?=$item->id ;?>">
