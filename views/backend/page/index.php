...
$list = Post::join('topic', 'post.topic_id', '=', 'topic.id')
    ...
    ->select(['post.id','title','post.slug','type','topic_id','image','post.status', 'topic.name AS topic_name'])
    ->get();
                           ...
                           <td>
                              ...
                              <div class="function_style">
                                 ...
                                 <?php endif; ?>
                                    ...
                                    <a class ="btn btn-primary btn-xs" href="index.php?option=page&cat=show&id=<?=$item->id ;?>">
