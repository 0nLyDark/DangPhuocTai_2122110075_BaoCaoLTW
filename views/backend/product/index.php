...
$list = Product::join('category', 'product.category_id', '=', 'category.id')
   ->join('brand', 'product.brand_id', '=', 'brand.id')
    ...
    ->select(['product.id','product.name','product.image','product.slug','product.status', 'category.name AS category_name','brand.name AS brand_name'])
    ->get();
                           ...
                           <tr class="datarow">
                              ...
                              <td>
                                 ...
                                 <div class="function_style">
                                       ...
                                       <a class ="btn btn-primary btn-xs" href="index.php?option=product&cat=show&id=<?=$item->id ;?>">
